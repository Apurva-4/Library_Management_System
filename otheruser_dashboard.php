    ...
    ?>
           <div class="container">
            ...
            $type= $row[4];
                ...
                ?>
            <table align="center">
            <tr><td><u>Person Name:</u></td> &nbsp&nbsp<td><?php echo $name ?></td></tr>
            <tr><td><u>Person Email:</u></td>&nbsp&nbsp<td><?php echo $email ?></td></tr>
            <tr><td><u>Account Type:</u></td> &nbsp&nbsp<td><?php echo $type ?></td></tr>
        </table>
            ...
            foreach($recordset as $row){
                $table.="<tr>";
               "<td>$row[0]</td>";
               $table.="<td><img src='uploads/$row[1]' width='50px' height='50px' style='border:1px solid #333333;'></td>";
               $table.="<td>$row[2]</td>";
                $table.="<td>$row[4]</td>";
                $table.="<td>$row[6]</td>";
                $table.="<td>$row[7]</td>";
